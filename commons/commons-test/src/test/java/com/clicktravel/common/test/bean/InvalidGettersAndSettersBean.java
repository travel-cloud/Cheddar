...
public class InvalidGettersAndSettersBean {
    ...
    public void setStringProperty1(final String stringProperty) {
    ...
    public void setStringProperty2(final String stringProperty) {
        stringProperty1 = stringProperty;
    }
