...
public class DomainEndPoint {
    ...
    private final String documentServiceEndPoint;
    private final String searchServiceEndPoint;

    public DomainEndPoint(final String documentServiceEndPoint, final String searchServiceEndPoint) {
    ...
    public String documentServiceEndPoint() {
        return "https://" + documentServiceEndPoint + "/2013-01-01/documents";
    }

    public String searchServiceEndPoint() {
        return "https://" + searchServiceEndPoint + "/2013-01-01";
    }
