...
@Component
public class IndexDefinitionToIndexFieldCollectionMapper extends CollectionMapper<IndexDefinition, IndexField> {

    public IndexDefinitionToIndexFieldCollectionMapper() {
        super(new IndexDefinitionToIndexFieldMapper());
    }
