 ...
 */
public class DynamoDbTemplateInfrastructureManager extends AbstractPersistenceManager {
    ...
    public DynamoDbTemplateInfrastructureManager(final AmazonDynamoDB amazonDynamoDbClient, final int readThroughput,
        ...
        dynamoDbTemplates = new HashSet<DynamoDbTemplate>();
    }
    ...
    public void init() {
        for (final DynamoDbTemplate dynamoDbTemplate : dynamoDbTemplates) {
            super.initSchema(dynamoDbTemplate.databaseSchemaHolder());
