...
public class UpdateAction<T extends Item> extends DatabaseAction<T> {

    public UpdateAction(final T item, final List<PersistenceExceptionHandler<?>> persistenceExceptionHandlers) {
