...
public class TransactionalSnsMessagePublisher implements MessagePublisher, TransactionalResource {
    ...
    public TransactionalSnsMessagePublisher(final SnsMessagePublisher snsMessagePublisher) {
    ...
    public void commit() throws TransactionException {
        ...
        transaction.applyActions(snsMessagePublisher);
    ...
    public String exchangeName() {
        return snsMessagePublisher.exchangeName();
    }
