...
public class SqsTypedMessageAdapter implements SqsMessageAdapter<TypedMessage> {

    @Override
    public String toSqsMessageBody(final TypedMessage typedMessage) {
    ...
    @Override
    public TypedMessage toMessage(final com.amazonaws.services.sqs.model.Message sqsMessage) {
