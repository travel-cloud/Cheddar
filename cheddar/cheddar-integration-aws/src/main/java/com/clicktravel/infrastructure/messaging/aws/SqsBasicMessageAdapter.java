...
public class SqsBasicMessageAdapter implements SqsMessageAdapter<BasicMessage> {

    @Override
    public String toSqsMessageBody(final BasicMessage basicMessage) {
        return basicMessage.getBody();
    }

    @Override
    public BasicMessage toMessage(final Message sqsMessage) {
