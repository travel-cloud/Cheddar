...
public class RemoteResponseMessageRegistry implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Autowired
    public RemoteResponseMessageRegistry(final MessageListener remoteResponseMessageListener,
            final RemoteResponseMessageHandler remoteResponseMessageHandler) {
        this.remoteResponseMessageListener = remoteResponseMessageListener;
        this.remoteResponseMessageHandler = remoteResponseMessageHandler;
    }
