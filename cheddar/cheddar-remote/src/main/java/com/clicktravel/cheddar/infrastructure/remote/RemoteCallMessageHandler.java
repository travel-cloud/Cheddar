...
@Component
public class RemoteCallMessageHandler implements MessageHandler {

    private final RemoteCallHandler remoteCallHandler;

    @Autowired
    public RemoteCallMessageHandler(final RemoteCallHandler remoteCallHandler) {
    ...
    public void handle(final Message message) throws MessageHandlingException {
        ...
        RemoteCall remoteCall = RemoteCall.deserialize(payload);
        remoteCallHandler.handle(remoteCall);
    }
