...
public class InMemoryDbDataGenerator {
    ...
    public static final String STUB_ITEM_TABLE_NAME = "stub_item_" + randomString(10);
    public static final String STUB_ITEM_WITH_RANGE_TABLE_NAME = "stub_item_with_range_" + randomString(10);
    public static final String STUB_ITEM_WITH_GSI_TABLE_NAME = "stub_item_with_gsi_" + randomString(10);
