...
public class InMemoryBasicMessageListener extends InMemoryMessageListener<BasicMessage> {

    private final MessageHandler<BasicMessage> messageHandler;

    public InMemoryBasicMessageListener(final MessageQueue<BasicMessage> basicMessageQueue,
            final MessageHandler<BasicMessage> messageHandler,
            final InMemoryMessageQueuePoller inMemoryMessageQueuePoller) {
        super(basicMessageQueue, inMemoryMessageQueuePoller);
