...
public class ContainerSecurityRequestFilter implements ContainerRequestFilter {
    ...
    public void filter(final ContainerRequestContext requestContext) throws IOException {
        ...
        final String agentIdentityProviderId = getValueForHeader(headers, CLICK_PLATFORM_AGENT_IDENTITY_PROVIDER_ID_HEADER);
        SecurityContextHolder.set(new DefaultSecurityContext(userId, teamId, agentUserId, appId, identityProviderId, agentIdentityProviderId));
    }
