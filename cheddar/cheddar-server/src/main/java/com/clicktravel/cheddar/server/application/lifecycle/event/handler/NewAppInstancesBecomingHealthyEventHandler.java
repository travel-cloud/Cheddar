...
@Component
public class NewAppInstancesBecomingHealthyEventHandler extends AbstractApplicationLifecycleEventHandler {
    ...
    public Class<? extends SystemEvent> getEventClass() {
        return NewAppInstancesBecomingHealthyEvent.class;
    }
