...
// Workaround for bug where injection of RateLimiter fails silently due to multiple RateLimiter candidate beans
@Component
public class RateLimiterConfiguration {
    ...
    @Autowired
    public RateLimiterConfiguration(final RateLimiter restRequestRateLimiter,
            final RateLimiter highPriorityDomainEventHandlerRateLimiter,
    ...
    public RateLimiter restRequestRateLimiter() {
        return restRequestRateLimiter;
    }

    public RateLimiter highPriorityDomainEventHandlerRateLimiter() {
        return highPriorityDomainEventHandlerRateLimiter;
    }

    public RateLimiter lowPriorityDomainEventHandlerRateLimiter() {
        return lowPriorityDomainEventHandlerRateLimiter;
    }
