...
@Component
public class OldAppInstancesEventProcessingHaltedEventHandler extends AbstractApplicationLifecycleEventHandler {
    ...
    public Class<? extends SystemEvent> getEventClass() {
        return OldAppInstancesEventProcessingHaltedEvent.class;
    }
