...
/**
 * System event to state an EC2 instance for an application has started
 */
public class ApplicationInstanceStartedEvent extends AbstractPlatformManagementEvent {
    ...
    public void setApplicationInstanceName(final String applicationInstanceName) {
