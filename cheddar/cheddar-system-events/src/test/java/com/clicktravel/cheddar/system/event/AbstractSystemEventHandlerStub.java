...
public class AbstractSystemEventHandlerStub extends AbstractSystemEventHandler {

    private boolean handled;

    public AbstractSystemEventHandlerStub(final String applicationName, final String applicationVersion) {
